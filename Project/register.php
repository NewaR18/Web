...
<html>
    ...
    <body style= "background-image: url('rise.jpg');">
                            ...
                            <tr>
                                <td>
                                    <div class="mid2">
                                        ...
                                        First Name:</br><input type="text" maxlength="10" size="40" name="fname" required></br></br>
                                        Middle Name:</br><input type="text" maxlength="10" size="40" name="mname"></br></br>
                                        Last Name:</br><input type="text" maxlength="10" size="40" name="lname" required></br></br>
                                        Email:</br><input type="email" size="40" name="email" required></br></br>
                                        ...
                                        </select><input type="number" name="phone"  required ></br>
                                        </br>
                                        Password:</br><input type="password" maxlength="20" size="40" name="password" required></br></br>
                                        Confirm Password:</br><input type="password" maxlength="20" size="40" name="password2" required></br></br>
